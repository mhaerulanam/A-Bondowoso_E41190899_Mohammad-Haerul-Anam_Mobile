package com.example.minggu10_gps_akasessensor;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgLightSensor.setOnClickListener((View.OnClickListener) this);
        imgProximitySensor.setOnClickListener((View.OnClickListener) this);
    }
